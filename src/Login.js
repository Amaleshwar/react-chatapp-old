...
export default class Login extends React.Component {
    ...
    validateUser(){
            ...
            Axios.post(`http://${ipaddress}:8000/user_validate`,formdata)
      ...
      handlenewuser(){
        this.setState({sucessmsg: ''});
          ...
          //  {
            ...
            var   userthere = users.filter(tempuname => tempuname.User_Name.toLowerCase().indexOf(usernmae_check.toLowerCase()) !== -1)
            //  //   console.log(users)
        ...
        // if(username!==''&&password!==''&&eamilid!=='' && password===confirmpwd ){     
            if(username!==''&& password!==''&& this.state.errormsg===''){   
                ...
                Axios.post(`http://${ipaddress}:8000/user_register`,formdata)
                .then(res=>{   console.log(res.statusText) 
